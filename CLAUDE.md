...
Never use the em dash character (-) anywhere in this repo - commit messages, markdown files, code, everything. Use a regular hyphen with spaces around it instead.
